...
export const DomainDetails = () => {
  ...
  return (
    <div className="p-2 sm:w-full w-full lg:w-full flex flex-col justify-evenly items-center ">
      <div className="flex justify-between w-full text-white px-4">
        <Title className="py-6 text-left text-lg lg:text-2xl md:text-xl">
          My Active Domains
        </Title>
        <Text className="flex items-center text-white text-xs lg:text-base md:text-sm">
          View all <IoIosArrowForward className="ml-1 lg:ml-3 md:ml-2" />
        </Text>
      </div>
